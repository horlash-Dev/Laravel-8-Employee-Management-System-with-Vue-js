              ...
              <div class="col-md-8 col-12">
                <div class="box">
                  <div class="box-header with-border">
                    <h4 class="box-title"><strong> Update My Application</strong></h4>
                  ...
                  <div class="box">
                    <div class="box-header with-border">
                        <router-link :to="{name: 'Index', params: {eid: edata.user}}" class="btn-primary btn px-3 py-2 mb-8">Back</router-link>
