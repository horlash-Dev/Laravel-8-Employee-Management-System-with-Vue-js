              ...
              <div class="col-md-8 col-12">
                <div class="box">
                  <div class="box-header with-border">
                    <h4 class="box-title"><strong> UPDATE {{$city->name}} CITY DETAILS</strong></h4>
                  ...
                  <div class="box">
                    ...
                    @endforeach
                      @endif
                    <!-- /.box-header -->
                    <form class="form" method="POST" action="{{ route('city.update', $city->name) }}">
                        @csrf
                        @method('PUT')
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" required name="name" value="{{ old('name',$city->name) }}" class="form-control" placeholder="Name">
                                </div>
                            </div>
                             <div class="form-group">
                                <label>Country</label>
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-control" name="state_id">
                                        ...
                                        <option  {{ ($list->id == $city->state_id) ? 'selected' : null}} value="{{$list->id}}">{{$list->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
