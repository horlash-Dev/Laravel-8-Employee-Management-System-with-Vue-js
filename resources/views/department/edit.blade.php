              ...
              <div class="col-md-8 col-12">
                <div class="box">
                  <div class="box-header with-border">
                    <h4 class="box-title"><strong> UPADTE {{$department->name}} DETAILS</strong></h4>
                  ...
                  <div class="box">
                    ...
                    @endforeach
                      @endif
                    <!-- /.box-header -->
                    <form class="form" method="POST" action="{{ route('department.update', $department->name) }}">
                        @csrf
                        @method('PUT')
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" required name="name" value="{{ old('name', $department->name) }}" class="form-control" placeholder="Name">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
