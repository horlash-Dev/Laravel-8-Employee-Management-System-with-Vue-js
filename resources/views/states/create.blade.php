              ...
              <div class="col-md-8 col-12">
                <div class="box">
                  <div class="box-header with-border">
                    <h4 class="box-title"><strong> REGISTER NEW STATE</strong></h4>
                  ...
                  <div class="box">
                    <div class="box-header with-border">
                      <h4 class="box-title font-weight-bold">ADD A NEW STATE</h4>
                      @if($errors->any())
                    ...
                    @endforeach
                      @endif
                    <!-- /.box-header -->
                    <form class="form" method="POST" action="{{ route('state.store') }}">
                        @csrf
                        <div class="box-body">
